...
export const envConfig = {
    ...
    KONG_LOGGEDIN_DEVICE_REGISTER_API: env.KONG_LOGGEDIN_DEVICE_REGISTER_API || '',
    KONG_REFRESH_TOKEN_API: env.KONG_REFRESH_TOKEN_API || '',
    ...
    SUNBIRD_LEARNER_PLAYER_URL: env.SUNBIRD_LEARNER_PLAYER_URL || '',
    ...
    SUNBIRD_LOGGEDIN_SESSION_TTL: parseInt(env.SUNBIRD_LOGGEDIN_SESSION_TTL || '86400000'),
