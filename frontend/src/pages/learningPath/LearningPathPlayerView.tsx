...
export function LearningPathPlayerView({
  ...
  // Finishing a content item moves the learner on, rather than leaving them
  // parked on something they have already completed. Only fires on the
  // not-complete -> complete transition, so re-opening a finished leaf to
  // review it does not bounce forward (see useAutoAdvanceContent).
