  ...
  useAppI18n: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        'close': 'Close',
        'createBatch.viewTitle': 'View Batch Details',
        'createBatch.editTitle': 'Edit Batch',
        'createBatch.createTitle': 'Create Batch',
        'createBatch.close': 'Close',
        'createBatch.cancel': 'Cancel',
        'createBatch.issueCertificate': 'Issue Certificate',
        'createBatch.batchType': 'Batch Type',
        'createBatch.batchTypeOpen': 'Open',
        'createBatch.saving': 'Saving…',
        'createBatch.creating': 'Creating…',
        'createBatch.saveChanges': 'Save Changes',
        'createBatch.create': 'Create Batch',
        'createBatch.failedToUpdate': 'Failed to update batch. Please try again.',
        'createBatch.failedToCreate': 'Failed to create batch. Please try again.',
        'mentorSection.title': 'Mentors in the Batch',
        'mentorSection.searchPlaceholder': 'Search mentors by name or email…',
        'mentorSection.noMentorsFound': 'No mentors found in your organisation.',
        'mentorSection.removeMentor': 'Remove {{name}}',
