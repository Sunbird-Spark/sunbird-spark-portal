...
const LoginToUnlockCard = () => {
  ...
  return (
    <div
      className="font-rubik w-full max-w-[21.875rem] min-h-[8.75rem] rounded-[1.25rem] border border-sunbird-status-ongoing-border bg-sunbird-status-ongoing-bg p-5 flex flex-col"
