...
type SubVariant = 'classic' | 'ember' | 'shatter' | 'melt' | 'ashes';

interface DissolveLoaderProps {
  message?: string;
...
function applyLogoState(p: number, sv: SubVariant): React.CSSProperties {
  if (sv === 'classic') {
...
function spawnParticles(p: number, sv: SubVariant, W: number, H: number, particles: Particle[]) {
