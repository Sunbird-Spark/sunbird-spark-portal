          ...
          return (
            <button
              ...
              className={cn(
                ...
                isHighlight &&
                  isActive &&
                  'bg-sunbird-brick text-white shadow-md hover:bg-sunbird-brick/90',
                isHighlight &&
                  !isActive &&
                  'bg-sunbird-brick text-white hover:bg-sunbird-brick/90 shadow-sm',
              )}
            >
              ...
              {'count' in item && item.count !== undefined && (
                <Badge
                  ...
                  className={cn(
                    ...
                    !isActive &&
                      !isHighlight &&
                      'bg-gray-100 text-muted-foreground border-transparent',
          ...
          <div className="px-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-sunbird-wave/10 rounded-xl p-3 text-center">
                <div className="text-xl font-bold text-sunbird-ink font-rubik">
                  {counts.published}
                </div>
              ...
              <div className="bg-sunbird-ginger/10 rounded-xl p-3 text-center">
                <div className="text-xl font-bold text-sunbird-brick font-rubik">
                  {counts.review}
                </div>
