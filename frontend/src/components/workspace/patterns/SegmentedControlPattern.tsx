        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          {userRole === 'creator' && (
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-sunbird-ginger to-sunbird-brick hover:from-sunbird-brick hover:to-sunbird-ginger text-white font-['Rubik'] rounded-2xl shadow-lg px-6"
            >
