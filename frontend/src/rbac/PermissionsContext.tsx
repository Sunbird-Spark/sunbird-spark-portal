// frontend/src/rbac/PermissionsContext.tsx
...
export const PermissionsProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <PermissionsContext.Provider value={{ roles, isLoading, isAuthenticated, error, hasAnyRole, canAccessFeature, refetch: fetchRoles }}>
      {children}
...
export function usePermissionsContext(): PermissionsState {
  ...
  if (!ctx) throw new Error('usePermissionsContext must be used within a PermissionsProvider');
  return ctx;
}
